...
class TestValidateState(unittest.TestCase):
    def test_validate_state(self):
        ...
        mock_config = {"start_date": "2019-09-09T00:00:00Z"}
        ...
        self.assertDictEqual(
            validate_state(mock_config, mock_catalog, mock_state_1), expected_state_1
        )

        self.assertDictEqual(
            validate_state(mock_config, mock_catalog, mock_state_2), expected_state_2
        )
